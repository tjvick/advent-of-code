...
def compute_value(children, type_id):
    match type_id:
        case 0:
            return sum(child['value'] for child in children)
        case 1:
            return np.prod([child['value'] for child in children])
        case 2:
    ...
    if type_id_val == 4:
        ...
        if length_type_id == '0':
            ...
            return {
                ...
                "type_id": type_id_val,
                "literal_value": None,
                "value": compute_value(children, type_id_val),
...
parent = parse_hex_packet(hex_string)
print(parent)
print(parent['value'])
