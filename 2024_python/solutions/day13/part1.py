...
class ClawMachine:
    ...
    def is_valid_number_of_presses(a_button_presses: float, b_button_presses: float):
        button_presses_are_whole_numbers = (
                abs(a_button_presses - round(a_button_presses)) < 1e-6 and
                abs(b_button_presses - round(b_button_presses)) < 1e-6
        )
        button_presses_are_within_reason = a_button_presses <= 1000 and b_button_presses <= 1000
        return button_presses_are_whole_numbers and button_presses_are_within_reason
