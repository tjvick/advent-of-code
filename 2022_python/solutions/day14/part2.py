...
y_floor = max(y for x, y in rock_grid) + 2
...
while (500, 0) not in sand_grid:
    ...
    while True:
        ...
        if down_spot in rock_grid or down_spot in sand_grid or down_spot[1] == y_floor:
            if down_left_spot in rock_grid or down_left_spot in sand_grid or down_left_spot[1] == y_floor:
                if down_right_spot in rock_grid or down_right_spot in sand_grid or down_left_spot[1] == y_floor:
                    # come to rest
